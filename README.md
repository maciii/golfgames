...
GitHub Actions**. GitHub Pages jsou zdarma pro veřejné repozitáře; u
privátního repozitáře na free plánu je potřeba použít jiný hosting
(Cloudflare Pages, Netlify) – ty mají zdarma i privátní repozitáře. Pro
hosting z kořene domény se buildí s `BASE_PATH=/`:
...
```
src/
  types.ts            datový model kola + pomocné výpočty
  ...
  screens/
    SetupScreen.tsx   volba hry, hráčů a počtu jamek
